...
if( !defined( 'MP_STACKS_DOWNLOADGRID_VERSION' ) )
	define( 'MP_STACKS_DOWNLOADGRID_VERSION', '1.0.0.5' );
...
function mp_stacks_downloadgrid_include_files(){
	 ...
	 */
		 ...
		 * enqueue scripts
		 */
		require( MP_STACKS_DOWNLOADGRID_PLUGIN_DIR . 'includes/misc-functions/enqueue-scripts.php' );
		...
		if ( function_exists('mp_stacks_developer_textdomain') ){
			require( MP_STACKS_DOWNLOADGRID_PLUGIN_DIR . 'includes/misc-functions/stack-template-functions.php' );
		}
