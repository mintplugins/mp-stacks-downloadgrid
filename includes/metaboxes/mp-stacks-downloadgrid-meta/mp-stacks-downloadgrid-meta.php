...
function mp_stacks_downloadgrid_create_meta_box(){
	...
	$mp_stacks_downloadgrid_items_array = array(
		...
		'downloadgrid_feat_img_note' => array(
			...
			'field_description' 	=> __( 'The following settings won\'t control the size of how the image displays. To change the actual display size of the images, change the "Downloads Per Row" option or change the "Maximum Content Width" under "Brick Size Settings".', 'mp_stacks_postgrid' ),
