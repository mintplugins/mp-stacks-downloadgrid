...
function mp_stacks_downloadgrid_create_meta_box(){
	...
	$mp_stacks_downloadgrid_items_array = array(
		...
		array(
			'field_id'			=> 'downloadgrid_show_featured_images',
		...
		array(
			'field_id'			=> 'downloadgrid_show_titles',
		...
		array(
			'field_id'			=> 'downloadgrid_titles_placement',
		...
		array(
			'field_id'			=> 'downloadgrid_show_title_backgrounds',
		...
		array(
			'field_id'			=> 'downloadgrid_show_excerpts',
		...
		array(
			...
			'field_title' 	=> __( 'Word Limit for Excerpt\'s', 'mp_stacks_downloadgrid'),
		...
		array(
			'field_id'			=> 'downloadgrid_show_excerpt_backgrounds',
		...
		array(
			'field_id'			=> 'downloadgrid_show_prices',
		...
		array(
			'field_id'			=> 'downloadgrid_show_price_backgrounds',
		...
		array(
			'field_id'			=> 'downloadgrid_show_load_more_button',
		...
		array(
			'field_id'			=> 'downloadgrid_mouse_over_load_more_button_color',
			'field_title' 	=> __( '"Load More" Button Text Color', 'mp_stacks_downloadgrid'),
		...
		array(
			'field_id'			=> 'downloadgrid_mouse_over_load_more_button_text_color',
			'field_title' 	=> __( '"Load More" Button Text Color', 'mp_stacks_downloadgrid'),
		...
		array(
			'field_id'			=> 'downloadgrid_load_more_text',
	...
	$global_mp_stacks_downloadgrid_items_array = $mp_stacks_downloadgrid_items_array;
