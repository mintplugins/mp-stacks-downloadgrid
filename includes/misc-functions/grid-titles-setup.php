 ...
 * 3. Make custom changes to the mp_stacks_downloadgrid_title function about what is displayed.
 *
 * @since 1.0.0
 *
...
function mp_stacks_downloadgrid_title_meta_options( $items_array ){		
	...
	//Title Settings
	$new_fields = array(
		'downloadgrid_title_showhider' => array(
		...
		'downloadgrid_title_placement' => array(
		...
		'downloadgrid_title_color' => array(
		...
		'downloadgrid_title_lineheight' => array(
			'field_id'			=> 'downloadgrid_title_lineheight',
			'field_title' 	=> __( 'Titles\' Line Height', 'mp_stacks_downloadgrid'),
			'field_description' 	=> __( 'Enter the line height for the excerpt text. Default: 24', 'mp_stacks_downloadgrid' ),
			'field_type' 	=> 'number',
			'field_value' => '24',
			'field_showhider' => 'downloadgrid_title_settings',
		),
		
		'downloadgrid_title_google_font' => array(
			'field_id'			=> 'downloadgrid_title_google_font',
		...
		'downloadgrid_title_google_font_weight_style' => array(
			'field_id'			=> 'downloadgrid_title_google_font_weight_style',
		...
		'downloadgrid_title_spacing' => array(
			'field_id'			=> 'downloadgrid_title_spacing',
		...
		'downloadgrid_title_animation_desc' => array(
		...
		'downloadgrid_title_animation_repeater_title' => array(
		...
		'downloadgrid_title_animation_length' => array(
		...
		'downloadgrid_title_animation_opacity' => array(
			'field_id'			=> 'opacity',
		...
		'downloadgrid_title_animation_ratation' => array(
			'field_id'			=> 'rotateZ',
		...
		'downloadgrid_title_animation_x' => array(
			'field_id'			=> 'translateX',
		...
		'downloadgrid_title_animation_y' => array(
			'field_id'			=> 'translateY',
		...
		//Title Background
		'downloadgrid_title_bg_showhider' => array(
		...
		'downloadgrid_title_bg_show' => array(
		...
		'downloadgrid_title_bg_size' => array(
		...
		'downloadgrid_title_bg_color' => array(
		...
		'downloadgrid_title_bg_opacity' => array(
...
add_filter( 'mp_stacks_downloadgrid_items_array', 'mp_stacks_downloadgrid_title_meta_options', 13 );
 ...
 */
function mp_stacks_downloadgrid_title_animation_js( $existing_filter_output, $post_id, $meta_prefix ){
	...
	$title_animation_js = mp_core_js_mouse_over_animate_child( '#mp-brick-' . $post_id . ' .mp-stacks-grid-item', '.mp-stacks-downloadgrid-item-title-holder', mp_core_get_post_meta( $post_id, 'downloadgrid_title_animation_keyframes', array() ), true, true, 'mp-brick-' . $post_id ); 

	return $existing_filter_output . $title_animation_js;
}
add_filter( 'mp_stacks_grid_js', 'mp_stacks_downloadgrid_title_animation_js', 10, 3 );
 ...
 */
function mp_stacks_downloadgrid_title_google_font( $css_output, $post_id, $first_content_type, $second_content_type ){
	...
	$downloadgrid_title_googlefont = mp_core_get_post_meta( $post_id, 'downloadgrid_title_google_font' );
	$downloadgrid_title_googlefontweight = mp_core_get_post_meta( $post_id, 'downloadgrid_title_google_font_weight_style' );
	
	//If a font name has been entered
	if ( !empty( $downloadgrid_title_googlefont ) ){
		
		//Check if a font extra (weight) has been selected and add it if so.
		$downloadgrid_title_googlefontweight = isset($downloadgrid_title_googlefontweight) && !empty( $downloadgrid_title_googlefontweight ) ? ':' . $downloadgrid_title_googlefontweight : NULL;
		$downloadgrid_title_googlefont = $downloadgrid_title_googlefont . $downloadgrid_title_googlefontweight;
	
		//Load the Google Font using the Google Font Class in MP Core
		new MP_CORE_Font( $downloadgrid_title_googlefont, $downloadgrid_title_googlefont, $mp_core_google_font_args );
		$mp_stacks_footer_inline_css[$downloadgrid_title_googlefont] = $mp_core_font_families[$downloadgrid_title_googlefont];
		
		//Return the incoming css string plus css to apply this font family to all paragraph tags
		$css_output .=  '#mp-brick-' . $post_id . ' .mp-stacks-downloadgrid-item-title, #mp-brick-' . $post_id . ' .mp-stacks-downloadgrid-item-title * { font-family: \'' . $downloadgrid_title_googlefont . '\';}';
	
	}
	
	return $css_output;	
}
add_filter('mp_brick_additional_css', 'mp_stacks_downloadgrid_title_google_font', 10, 4);	